...
// import { savePost, updatePost } from "../config/postApi";
...
//   const [modalIsOpenSaveTravelDiary, setModalIsOpenSaveTravelDiary] =
//     useState(false);
...
//           diaryInputs.map((input) =>
//             input.id === id
//               ? { ...input, image: { ...input.image, [index]: file } }
//               : input
//           )
//         );
//       } else {
//         setTravelContent(
//           travelContent.map((entry) =>
//             entry.id === id
//               ? { ...entry, image: { ...entry.image, [index]: file } }
//               : entry
//           )
//         );
//       }
...
//     const updatedEntry = {
//       ...newEntry,
//       image: { ...newEntry.image, [index]: file },
//     };
...
//       diaryInputs.map((input) =>
//         input.id === id
//           ? { ...input, image: { ...input.image, [index]: null } }
//           : input
//       )
//     );
//   };
...
//     setDiaryInputs(
//       diaryInputs.map((input) =>
//         input.id === id ? { ...input, diaryTitle: title } : input
//       )
//     );
//     //newEntry의 제목 변경
...
//     setDiaryInputs(
//       diaryInputs.map((input) =>
//         input.id === id ? { ...input, date: date } : input
//       )
//     );
//     // 선택된 날짜를 상태에 추가
...
//   //             i === index
//   //               ? { ...input, image: { ...input.image, [i]: file } }
//   //               : input
//   //           )
//   //         );
//   //       } else {
...
//   //             i === index
//   //               ? { ...entry, image: { ...entry.image, [i]: file } }
//   //               : entry
//   //           )
//   //         );
//   //       }
...
//   const saveDiaries = async (postId) => {
//     const diarySaveRequest = [];
//     diaryInputs.forEach((el) =>
//       diarySaveRequest.push({
//         postId: postId,
//         title: el.diaryTitle,
...
//       })
//     );
//     const diaryIds = await saveDiary(diarySaveRequest);
//     return diaryIds;
//   };

//   const savePhotosForDiary = async (postId, diaryIds) => {
//     // const photoPaths = [];
//     const photoSaveRequest = [];
//     // const formData = new FormData();

//     diaryInputs.forEach((el, i) => {
//       console.log(el);
...
//         formData.append("files", el.image[index]);
//         // console.log(formData);
//       });
//       photoSaveRequest.push(formData);
...
//     const getScope = document.getElementById("public-post").checked
//       ? "PUBLIC"
//       : "PERSONAL";
...
//       title: getPostTitle,
//     });
//     const diaryIds = await saveDiaries(postId);
...
//                   onChange={(e) =>
//                     handleDiaryTitleChange(e.target.value, input.id)
//                   }
...
//                         >
//                           <button
//                             onClick={() => deleteImage(i, input.id)}
//                             style={{
