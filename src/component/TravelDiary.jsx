...
const TravelDiary = () => {
  ...
  const saveDiaryAndPhoto = async () => {
    ...
    diaryInputs.forEach((el) =>
      diaryRequestDto.push({
        id: el.id,
        title: el.diarytTitle,
    ...
    <div className="travel">
      {initDiary && (
        <div>
          ...
          <button className="create-diary-button" onClick={createDiary}>
            +
          </button>
        </div>
      )}
      {showPostTitle && (
        <>
          ...
          <div className="public">
            <button
              onClick={handleSaveTravelDiaryPublic}
              className="save-travel-diary"
            >
              발행
            </button>
          </div>
      ...
      {initExpense && (
        <div>
          ...
          <button className="create-expense-button" onClick={createExpense}>
            +
          </button>
        </div>
      )}
